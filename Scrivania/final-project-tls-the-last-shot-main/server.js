...
spot4.setEnabled(false);
    ...
    const fences = [];
        ...
        const buildingborder4 = BABYLON.MeshBuilder.CreateBox("buildingborder4", {width: 10, height: 30, depth: 165}, scene);
		buildingborder4.position = new BABYLON.Vector3(70, 0, 0);
